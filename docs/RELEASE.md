...
4. Commit all changes, create an annotated tag (e.g. `v1.2.8`), and push branch and tag. The release workflow will create the GitHub Release with the changelog.
...
git add -A
git status   # review
git commit -m "Release 1.2.8: inline styles for toggle icon visibility"
git tag -a v1.2.8 -m "Release 1.2.8"
