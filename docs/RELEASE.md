...
git add -A
git status   # review
git commit -m "Release 2.2.1: FrankenPHP sticky Kernel audit (reset_kernel false)"
git tag -a v2.2.1 -m "Release 2.2.1: FrankenPHP sticky Kernel audit (reset_kernel false)"
