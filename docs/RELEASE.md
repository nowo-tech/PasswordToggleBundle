...
4. Commit all changes, create an annotated tag (e.g. `v1.2.4`), and push branch and tag. The release workflow will create the GitHub Release with the changelog.
...
git add -A
git status   # review
git commit -m "Release 1.2.4: UX Icons detection, Flex recipe, graceful icon fallback"
